...
VNG_7025,VNG_7026,VNG_7027,VNG_7028
        ...
        <sup id="fn3">3. Present address: Lieber Institute for Brain Development, Baltimore, MD, USA</sup><br/>
        <sup id="fn4">4. Present address: Institute of Biological Sciences, Federal University of Minas Gerais, Belo Horizonte, Brazil</sup><br/>
        <sup id="fn5">5. Present address: Center for Systems Biology, University of Iceland, Reykjavik, Iceland</sup><br/>
        <sup id="fn6">6. Present address: Prokaryotic RNA Biology, Phillips-Universität Marburg, Marburg, Germany</sup><br/>
        <sup id="fn7">7. Department of Computation and Mathematics, Faculty of Philosophy, Sciences and Letters at Ribeirão Preto, University of São Paulo, Ribeirão Preto, Brazil</sup><br/>
        <sup id="fn8">8. Departments of Biology and Microbiology, University of Washington, Seattle, WA, USA</sup><br/>
        <sup id="fn9">9. Molecular and Cellular Biology Program, University of Washington, Seattle, WA, USA</sup><br/>
        <sup id="fn10">10. Lawrence Berkeley National Lab, Berkeley, CA, USA</sup><br/>
      </v-col>
    </v-row>
  </v-container>
</template>
