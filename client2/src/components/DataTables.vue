<template>
  <v-container style="width: 80%; margin: auto">
    ...
    <v-row class="text-left">
      <v-col class="mb-4">
        <p>Welcome to the <i>H. salinarum</i> NRC-1 Atlas! In this web portal, you can explore a multi-omics growth curve experiment for this archaeal organism. Below, you will find an interactive table with linked locus tags that will take you to a single-nucleotide resolution genome browser displaying time point-wise transcriptome profiles and miscellaneous features for a given gene and its neighbors. You can also browse the data by visualizing an interactive heat map of all genes with their transcript and protein levels accompanied by miscellaneous features (<router-link to="/heatmap">"Atlas"</router-link> tab). The <router-link to="/about">"About"</router-link> section provides a detailed description of this web portal. For the best user experience, please, use the <a target="_blank" href="https://www.google.com/intl/en-US/chrome/">Google Chrome Browser</a> or the <a target="_blank" href="https://www.mozilla.org/en-US/firefox/new/">Mozilla Firefox Browser</a>.</p>
        <p style="font-style: italic">Type the gene locus tag or the protein product in the search box to query for representative genes. Once you find the representative gene of choice, click on the locus tag (first or third column) to see it in the genome browser.</p>
      </v-col>
    </v-row>
